...
-- Exercicio 07 --
SELECT * FROM Livro WHERE id BETWEEN 303 AND 306;
...
ON Emprestimo.livro_id = Livro.id
...
-- Exercicio 11 --
SELECT * FROM Livro LIMIT 5 OFFSET 3;

-- Exercicio 12 --
SELECT titulo FROM Livro WHERE titulo LIKE '_____rry';
...
WHERE Livro.titulo LIKE 'O%' AND Categoria.nome IN ('Mistério', 'Ficção', 'Fantasia') AND Emprestimo.data_emprestimo BETWEEN '2024-01-01' AND '2024-02-29';
